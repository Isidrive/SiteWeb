...
//Affichage des produits selon le numéro de la page
        ...
        $reqresult = $cnn->prepare("select pronum,prolib,proprix,proimg,sounum from produit where prolib LIKE '%". $txtrech ."%' and pronum not in(Select * from(SELECT pronum from produit prolib LIKE '%". $txtrech ."%' ORDER BY pronum LIMIT $id )as temp) ORDER BY pronum limit 10");
